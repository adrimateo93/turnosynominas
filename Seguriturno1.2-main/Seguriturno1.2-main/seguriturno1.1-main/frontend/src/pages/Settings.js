...
export default function Settings() {
  ...
  const [settings, setSettings] = useState({
    ...
    plus_nochebuena_nochevieja: false,
    ...
    <div className="max-w-4xl mx-auto space-y-6" data-testid="settings-page">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <Label className="form-label">Trienios (cada 3 años)</Label>
              <Input
                type="number"
                min="0"
                max="10"
            ...
            <div className="space-y-2">
              <Label className="form-label">Quinquenios (cada 5 años)</Label>
              <Input
                type="number"
                min="0"
                max="6"
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div className="space-y-2 p-3 rounded-lg border">
                <Label className="text-sm font-medium">Plus Festivo y Fin de Semana</Label>
                <p className="text-xs text-muted-foreground">1,02 €/hora</p>
                <div className="flex items-center gap-2">
                  <Input
                    ...
                    step="0.5"
                    placeholder="Horas"
                    value={settings.plus_festivo_horas || ""}
                    onChange={(e) => setSettings({ ...settings, plus_festivo_horas: parseFloat(e.target.value) || 0 })}
                    className="w-24"
                  />
                  <span className="text-xs text-muted-foreground">horas</span>
                  {settings.plus_festivo_horas > 0 && (
                    <span className="text-sm font-medium text-green-600 ml-auto">
                      +{(settings.plus_festivo_horas * 1.02).toFixed(2)} €
                    </span>
                  )}
                </div>
              </div>
              ...
              <div className="space-y-2 p-3 rounded-lg border">
                <Label className="text-sm font-medium">Plus Nochebuena y Nochevieja</Label>
                <p className="text-xs text-muted-foreground">312,99 €/mes (83,48 € por noche)</p>
                <div className="flex items-center gap-3">
                  <Switch
                    checked={settings.plus_nochebuena_nochevieja}
                    onCheckedChange={(checked) => setSettings({ ...settings, plus_nochebuena_nochevieja: checked })}
                  />
                  <span className="text-sm">{settings.plus_nochebuena_nochevieja ? "Sí" : "No"}</span>
                  {settings.plus_nochebuena_nochevieja && (
                    <span className="text-sm font-medium text-green-600 ml-auto">
                      +312,99 €
                    </span>
                  )}
