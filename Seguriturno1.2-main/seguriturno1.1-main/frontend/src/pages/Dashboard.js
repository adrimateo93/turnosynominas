                  ...
                  {day.shifts?.map((shift) => (
                    ...
                    >
                      <div className="shift-time-row">
                        ...
                        {shift.alarm_enabled && <Bell className="shift-icon" />}
                        <span className="shift-time-main">{shift.start_time.slice(0,5)}-{shift.end_time.slice(0,5)}</span>
                        {shift.night_hours > 0 && <Moon className="shift-icon ml-auto" />}
                        {shift.comment && <MessageSquare className="shift-icon opacity-75" />}
                      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="flex items-center justify-between p-3 bg-muted rounded-lg">
              <div className="flex items-center gap-2">
                ...
                <Label className="font-medium">Turno Partido</Label>
              </div>
            ...
            <div className="space-y-2">
              <Label className="text-xs uppercase font-semibold">
                {isTurnoPartido ? "Primer Turno" : "Horario"}
              </Label>
            ...
            {isTurnoPartido && (
              <div className="space-y-2 p-3 bg-muted/50 rounded-lg border-2 border-dashed">
                <Label className="text-xs uppercase font-semibold">Segundo Turno</Label>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <Label className="text-xs text-muted-foreground">Entrada</Label>
                    <Input
        ...
        <DialogContent className="max-w-sm">
          ...
          <div className="space-y-4">
            <p className="text-sm text-muted-foreground">
              Dos calendarios independientes para cada empresa.
            </p>
